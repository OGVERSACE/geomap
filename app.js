...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="55" height="55">
    ...
    <g filter="url(#shadow)">
        ...
        <circle cx="249" cy="165" r="120" fill="white" stroke="rgba(0,0,0,0.15)" stroke-width="2"/>
        
        <!-- Дополнительная внутренняя тень для объёма -->
        <circle cx="249" cy="165" r="120" fill="none" stroke="rgba(0,0,0,0.05)" stroke-width="4"/>
        
        <!-- КРУПНЫЙ чёрный номер -->
        <text x="249" y="182" font-size="150" font-weight="bold" 
